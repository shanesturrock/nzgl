...
License:	GPL
URL:		http://circos.ca/
Source0:	http://circos.ca/distribution/circos-0.67-1.tgz
# Source0:	http://circos.ca/distribution/circos-%{ver}-1.tgz
Source1:	circos.sh
...
%changelog
* Mon Oct 13 2014 Shane Sturrock <shane@biomatters.com> - 0.67.1-1
- Bugfix release
