...
%changelog
* Thu Aug 24 2017 Shane Sturrock <shane.sturrock@nzgenomics.co.nz> - 0.69.6-1
- Bug fix release
...
* Mon Jun 27 2016 Shane Sturrock <shane@biomatters.com> - 0.69.3-1
- Bug fix release
...
- Fixed a bug that was introduced in the previous release that broke
  abbreviation of command-line flags.
