...
%post
alternatives \
   --install %{_bindir}/samtools samtools /usr/lib64/samtools%{priority}/bin/samtools %{priority} \
   --slave %{_bindir}/ace2sam ace2sam /usr/lib64/samtools%{priority}/bin/ace2sam \
   --slave %{_bindir}/blast2sam.pl blast2sam.pl /usr/lib64/samtools%{priority}/bin/blast2sam.pl \
   --slave %{_bindir}/bowtie2sam.pl bowtie2sam.pl /usr/lib64/samtools%{priority}/bin/bowtie2sam.pl \
   --slave %{_bindir}/export2sam.pl export2sam.pl /usr/lib64/samtools%{priority}/bin/export2sam.pl \
   --slave %{_bindir}/interpolate_sam.pl interpolate_sam.pl /usr/lib64/samtools%{priority}/bin/interpolate_sam.pl \
   --slave %{_bindir}/maq2sam-long maq2sam-long /usr/lib64/samtools%{priority}/bin/maq2sam-long \
   --slave %{_bindir}/maq2sam-short maq2sam-short /usr/lib64/samtools%{priority}/bin/maq2sam-short \
   --slave %{_bindir}/md5fa md5fa /usr/lib64/samtools%{priority}/bin/md5fa \
   --slave %{_bindir}/md5sum-lite md5sum-lite /usr/lib64/samtools%{priority}/bin/md5sum-lite \
   --slave %{_bindir}/novo2sam.pl novo2sam.pl /usr/lib64/samtools%{priority}/bin/novo2sam.pl \
   --slave %{_bindir}/plot-bamstats plot-bamstats /usr/lib64/samtools%{priority}/bin/plot-bamstats \
   --slave %{_bindir}/psl2sam.pl psl2sam.pl /usr/lib64/samtools%{priority}/bin/psl2sam.pl \
   --slave %{_bindir}/sam2vcf.pl sam2vcf.pl /usr/lib64/samtools%{priority}/bin/sam2vcf.pl \
   --slave %{_bindir}/samtools.pl samtools.pl /usr/lib64/samtools%{priority}/bin/samtools.pl \
   --slave %{_bindir}/seq_cache_populate.pl seq_cache_populate.pl /usr/lib64/samtools%{priority}/bin/seq_cache_populate.pl \
   --slave %{_bindir}/soap2sam.pl soap2sam.pl /usr/lib64/samtools%{priority}/bin/soap2sam.pl \
   --slave %{_bindir}/varfilter.py varfilter.py /usr/lib64/samtools%{priority}/bin/varfilter.py \
   --slave %{_bindir}/wgsim wgsim /usr/lib64/samtools%{priority}/bin/wgsim \
   --slave %{_bindir}/wgsim_eval.pl wgsim_eval.pl /usr/lib64/samtools%{priority}/bin/wgsim_eval.pl \
   --slave %{_bindir}/zoom2sam.pl zoom2sam.pl /usr/lib64/samtools%{priority}/bin/zoom2sam.pl \
   --slave %{_mandir}/man1/samtools.1 samtools.1 /usr/lib64/samtools%{priority}/man/man1/samtools.1

%postun
if [ $1 -eq 0 ]
then
  alternatives --remove samtools /usr/lib64/samtools%{priority}/bin/samtools
fi
