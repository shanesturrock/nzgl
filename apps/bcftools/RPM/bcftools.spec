...
%post
alternatives \
   --install %{_bindir}/bcftools bcftools /usr/lib64/bcftools%{priority}/bin/bcftools %{priority} \
   --slave %{_bindir}/plot-vcfstats plot-vcfstats /usr/lib64/bcftools%{priority}14/bin/plot-vcfstats \
   --slave %{_bindir}/vcfutils.pl vcfutils.pl /usr/lib64/bcftools%{priority}14/bin/vcfutils.pl \
   --slave %{_mandir}/man1/bcftools.1 bcftools.1 /usr/lib64/bcftools%{priority}14/man/man1/bcftools.1
