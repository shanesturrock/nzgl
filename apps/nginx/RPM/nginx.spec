...
Source8:           http://www.grid.net.ru/nginx/download/nginx_upload_module-2.2.0.tar.gz
...
%changelog
* Thu Aug 08 2012 Carl Jones <carl@biomatters.com> - 1.0.15-3
- Add upload module for internal build
