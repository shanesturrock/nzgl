...
URL: http://www.bioconductor.org/packages/2.11/bioc/src/contrib/%{short_name}_%{version}.tar.gz
Source0: http://www.bioconductor.org/packages/2.11/bioc/src/contrib/%{short_name}_%{version}.tar.gz
...
%changelog
* Mon Sep 23 2013 Shane Sturrock <shane@biomatters.com> - 3.16.8-1
- New upstream release
* Wed Jul 31 2013 Shane Sturrock <shane@biomatters.com> - 3.16.7-1
- New upstream release
* Wed Jul 17 2013 Shane Sturrock <shane@biomatters.com> - 3.16.6-1
- New upstream release
* Wed May 29 2013 Simon Buxton <simon@biomatters.com> - 3.16.5-1
- New upstream release
