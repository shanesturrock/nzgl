...
network --onboot yes --device eth0 --bootproto static --ip 10.10.2.101 --netmask 255.255.255.0 --gateway 10.10.2.254 --nameserver 10.0.1.1 --hostname download.nzgenomics.co.nz
